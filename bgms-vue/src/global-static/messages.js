...
var messages = {
  ...
  toolbar: {
    ...
    plot: {
      ...
      linkGraveRef: {
        ...
        save: {
          title: baseMessages.confirmation.title,
          text: "Do you want to save the changes to the details on the plot?"
        },
        verify: {
          title: "Please use the verify button first to confirm the grave number is available",
        }
      },
      delete: {
        confirmation: {
  ...
  graveLinks: {
    save: {
      success: {
        title: "Grave link added"
      },
      fail: {
        title: "Unable to add grave link"
      },
    },
    delete: {
      success: {
        title: "Grave link deleted"
      },
      fail: {
        title: "Unable to delete grave link"
      },
    },
  },
};
