...
#url that points to the aerial server, DOSEN'T END IN SLASH
AERIAL_SERVER_URL = 'https://maps.burialgrounds.co.uk/BGMS_aerial'

BASE_SERVER_URL = 'https://maps.burialgrounds.co.uk/OS_basemap/wmts/OSBasemap/{TileMatrixSet}/{TileMatrix}/{TileCol}/{TileRow}.png'
