...
AWS_STORAGE_BUCKET_NAME = 'bgmscompressed' #'bgmsstaticstaging'
...
#adding loaderio app to staging env only so that it is not available in production
SHARED_APPS += ('loaderio',)
INSTALLED_APPS = list(set(SHARED_APPS + TENANT_APPS))
#using the staging variable in url conf to add it to url patterns if it exists
...
EMAIL_AG_ADMIN = ['thurst@atlanticgeomatics.co.uk','mnomesque@atlanticgeomatics.co.uk']
